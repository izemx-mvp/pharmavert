  ...
  head: () => ({
    meta: [
      { title: "Partenaires — Pharmavert" },
      {
        name: "description",
        content:
          "Pharmavert s'appuie sur un réseau de pharmacies, grossistes, médecins et distributeurs pour commercialiser ses gammes au Maroc.",
      },
...
const partners = [
  {
    ...
    bullets: [
      ...
      "Livraison et suivi personnalisé",
    ],
  },
  {
    icon: Truck,
    ...
    bullets: [
      ...
      "Partenariat durable et structuré",
    ],
  },
  {
    icon: Stethoscope,
    ...
    bullets: [
      "Produits cliniquement pertinents",
        ...
        <div className="pv-container relative z-10 max-w-3xl">
          <Reveal>
            ...
            <p className="text-lg text-white/85">
              Pharmavert s'appuie sur un réseau solide de pharmacies, grossistes, médecins et
              distributeurs pour commercialiser ses gammes de produits.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="pv-container text-center max-w-3xl mx-auto">
          <Reveal>
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
              Rejoignez le réseau Pharmavert
            </h2>
            <p className="text-white/85 mb-8">
              Remplissez notre formulaire pour soumettre votre demande de partenariat. Notre équipe
