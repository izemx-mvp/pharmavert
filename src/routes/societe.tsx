  ...
  head: () => ({
    meta: [
      { title: "Société — Pharmavert" },
      {
        name: "description",
        content:
          "Pharmavert : société marocaine de promotion et distribution de compléments alimentaires et cosmétiques à marques propres.",
      },
      { property: "og:title", content: "À Propos de Pharmavert" },
      {
        property: "og:description",
        content: "Découvrez la mission, la vision et les valeurs de Pharmavert au Maroc.",
      },
        ...
        <div className="pv-container grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal delay={0.1}>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              commercialisation de produits alimentaires et cosmétiques. L'entreprise dispose de ses
              propres marques de produits et s'appuie sur un réseau structuré de pharmacies,
              grossistes, médecins et distributeurs pour assurer leur commercialisation à l'échelle
              nationale. Pharmavert ambitionne de renforcer sa présence digitale à travers le site
              pharmavert.ma, vitrine professionnelle de ses marques et catalogue produits.
            </p>
          </Reveal>
        </div>

        <div className="pv-container mt-16 grid grid-cols-2 md:grid-cols-4 gap-5">
          {["4 Produits Phares", "Marques Propres", "Réseau National", "Présence Digitale"].map(
            (m, i) => (
      ...
      <section className="section-pad bg-white border-t">
        <div className="pv-container grid md:grid-cols-2 gap-8">
          {[
            {
              t: "Notre Mission",
              d: "Développer et promouvoir des compléments alimentaires et produits cosmétiques de qualité, distribués efficacement auprès des professionnels de santé et partenaires du secteur pharmaceutique marocain.",
            },
            {
              t: "Notre Vision",
              d: "Devenir la référence marocaine en promotion et distribution de produits alimentaires et cosmétiques à marques propres, en renforçant notre réseau partenarial et notre visibilité digitale.",
            },
          ].map((c, i) => (
        ...
        <div className="pv-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: Leaf,
                t: "Compléments Alimentaires",
                d: "Bioactifs naturels, nutraceutiques et produits de santé",
              },
              {
                icon: Sparkles,
                t: "Produits Cosmétiques",
                d: "Soins et cosmétiques pour les professionnels de santé",
              },
              {
                icon: Store,
                t: "Réseau Pharmacies",
                d: "Distribution en officine à travers le Maroc",
              },
              {
                icon: BarChart2,
                t: "Promotion Professionnelle",
                d: "Promotion active auprès des médecins, grossistes et distributeurs",
              },
            ].map((c, i) => (
              <Reveal key={c.t} delay={i * 0.05}>
            ...
            {[
              {
                icon: Shield,
                t: "Qualité",
                d: "Des produits rigoureusement formulés et contrôlés",
              },
              {
                icon: Heart,
                t: "Proximité",
                d: "Un accompagnement personnalisé de chaque partenaire",
              },
              {
                icon: Globe,
                t: "Ambition",
                d: "Une vision nationale avec des standards internationaux",
              },
            ].map((c, i) => (
              <Reveal key={c.t} delay={i * 0.05}>
